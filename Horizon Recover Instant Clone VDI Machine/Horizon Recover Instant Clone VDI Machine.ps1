...
# Test arguments
Test-ArgsCount -ArgsCount 4 -Reason 'The Console or Monitor may not be connected to the VMware Horizon environment, please check this.'
...
# get the pool
$desktop_pool=Get-HVDesktopPool -hvpoolname $strHVMachinePool -HVConnectionServer $objHVConnectionServer

# Get the machine

$poolid=$desktop_pool.id

$machine = get-hvdesktopmachine -HVConnectionServer $objHVConnectionServer -HVMachineName $strHVMachineName -HVPoolID $poolid
