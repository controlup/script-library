...
<#
    ...
    01/01/24  GRL  Removed system process from exclude filter
#>
...
[string]$procmonFilter = ''
...
try
{
    $existingProcmons = Get-Process -Name procmon* -ErrorAction SilentlyContinue | Select-Object -ExpandProperty Id
...
#>
    ...
    if( $traceEvents -and $traceEvents.Count )
    {
        ...
        {
            [pscustomobject][ordered]@{ 'Operation' = $_.Key ; 'TotalSec' = [math]::Round( ($_.Value | Measure-Object -Property Duration -Sum | Select-Object -ExpandProperty Sum ) , 3 ) } 
        })
        ...
        if ($durationsbyoperation -and $durationsbyoperation.Count )
        {
            ...
            Write-Output "======================================="
            $durationsbyoperation | Sort-Object TotalSec -Descending | Select-Object -first 10 | Format-Table Operation, TotalSec -Wrap
        }

        # Display individual operations that took the longest
        $top10ops = @( $traceEvents | Sort-Object Duration -Descending | Select-Object -first 10 )
        ...
        $top10paths = @( $traceEvents | Where-Object { $_.Path -match '^[a-z]:\\' } | Group-Object -Property Path | Sort-Object Count -Descending | Select-Object Name, Count -First 10 )
