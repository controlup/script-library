...
<#
    .SYNOPSIS
    Take Horizon View machine out of Maintenance

    .DESCRIPTION
    This script removes a Horizon View machine from Maintence through the VMware.Hv.Helper module
...
# Disable Horizon View machine Maintenance
Set-HorizonViewMachineMaintenanceMode -HVMachine $objHVMachine -HVConnectionServer $objHVConnectionServer -MaintenanceMode Leave
