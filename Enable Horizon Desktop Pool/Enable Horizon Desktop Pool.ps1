...
<#
    ...
    .DESCRIPTION
    This script enables a Horizon Desktop pool through the VMware.Hv.Helper module

    .EXAMPLE
    Can be used as an Automated action to enable a Horizon Desktop pool after plannend maintenance
...
# Enable the Horizon Virtual Desktop Pool
Set-HorizonViewPoolEnablement -HVPool $objHVPool -HVConnectionServer $objHvConnectionServer -Enable:$true
