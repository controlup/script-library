...
<#
    ...
    .DESCRIPTION
    This script enables Horizon View Virtual Desktop pool provisioning through the VMware.Hv.Helper module

    .EXAMPLE
    Can be used as an Automated action to enable Horizon View Virtual Desktop pool if there are enough resources available
...
Set-HorizonViewPoolProvisioningEnablement -HVPool $objHVPool -HVConnectionServer $objHvConnectionServer -Enable:$true
