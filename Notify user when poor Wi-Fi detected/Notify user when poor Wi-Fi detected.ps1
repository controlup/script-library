...
Application to set as source for notification. Use Get-StartApps to see what is available
...
{
    #Throw "This script only works on Windows 10, Server 2019 and higher, this is $(Get-CimInstance -ClassName Win32_OperatingSystem | Select-Object -ExpandProperty Caption)"
}
